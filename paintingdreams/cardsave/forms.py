...
class CardsaveResultForm(forms.Form):
    ...
    CustomerName = forms.CharField(widget=forms.HiddenInput, required=False, strip=False)
    Address1 = forms.CharField(widget=forms.HiddenInput, required=False, strip=False)
    Address2 = forms.CharField(widget=forms.HiddenInput, required=False, strip=False)
    Address3 = forms.CharField(widget=forms.HiddenInput, required=False, strip=False)
    Address4 = forms.CharField(widget=forms.HiddenInput, required=False, strip=False)
    City = forms.CharField(widget=forms.HiddenInput, required=False, strip=False)
    State = forms.CharField(widget=forms.HiddenInput, required=False, strip=False)
    PostCode = forms.CharField(widget=forms.HiddenInput, required=False, strip=False)
    CountryCode = forms.IntegerField(widget=forms.HiddenInput)
    EmailAddress = forms.CharField(widget=forms.HiddenInput, required=False, strip=False)
